...
-- AddForeignKey
ALTER TABLE `Enrollments` ADD CONSTRAINT `Enrollments_channelId_fkey` FOREIGN KEY (`channelId`) REFERENCES `Channels`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Enrollments` ADD CONSTRAINT `Enrollments_promotionId_fkey` FOREIGN KEY (`promotionId`) REFERENCES `Promotions`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Enrollments` ADD CONSTRAINT `Enrollments_careersId_fkey` FOREIGN KEY (`careersId`) REFERENCES `Careers`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
