...
async update(id: string, dto: UpdateEnrollmentDto) {
  ...
  async remove(id: string) {
    ...
    return TransformResponse.map(data, 'Inscripción eliminada con éxito!!', 'DELETE');
  }
  ...
  async findOneByUser(userId: string, enrollmentId: string) {
    ...
    if (!data) {
      throw new HttpException('Inscripción no encontrada para este usuario.', HttpStatus.NOT_FOUND);
    }
