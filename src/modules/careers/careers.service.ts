...
export class CareersService extends PrismaClient implements OnModuleInit {
  ...
  async create(createCareerDto: CreateCareerDto) {
    ...
    return TransformResponse.map(data, 'Carrera creada con éxito!!', 'POST', HttpStatus.CREATED)
  }
  ...
  async remove(id: string) {
    ...
    return TransformResponse.map(data, 'Carrera eliminada con éxito!!', 'DELETE')
  }
